...
from oss_license_guide.citations.resolver import resolve_claims, validate_claims
from oss_license_guide.rules.evaluator import AnalysisResult
from oss_license_guide.rules.schema import AnalysisOutcome
...
def build_answer(result: AnalysisResult, scenario: Scenario, catalog: Catalog) -> Answer:
    ...
    return Answer(
        ...
        evidence=_evidence(obligations),
...
def _escalation(result: AnalysisResult) -> str:
    ...
    return "No escalation required for this outcome; assumptions are disclosed."
